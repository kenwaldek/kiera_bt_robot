      ...
      void loop() { 
        if (Serial.available() > 0) {
          ...
          switch (state) {
            ...
            rechts();
            break;
            case 'a': // this is in ascii code 97 / turns kiera 180° when recieving 'a'
            rechts180();
            break; 
            case 100: // this ascii code is the letter d > + speed
            S = S + 10;
            if (S > 70) {
              S = 70;
            }
            break; 
            case 99: // this ascii code is the letter c < - speed 
            S = S - 10;
            break; 
